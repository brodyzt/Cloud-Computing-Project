...
MASTER_KEY = "EQkhTCCiwQZ20vtD0cqcqjXaGH8OtSEaqzVHMiSOp65kjD9zbze0OX5eXcPob2P4f2q11I5lPpoTysEevVx4UA=="
DATABASE_ID = "edgeserverdatabase"
COLLECTION_ID = "regularsensordatacollection"
...
class DocumentManagement:
    ...
    @staticmethod
    def QueryItems(client):
        query = {'query': 'SELECT * FROM server s WHERE s.subtotal > 500'}
...
def run_sample():
    with IDisposable(cosmos_client.CosmosClient(HOST, {'masterKey': MASTER_KEY} )) as client:
        try:
            ...
            DocumentManagement.QueryItems(client)
